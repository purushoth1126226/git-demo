    ...
    <div class="card shadow-sm">
        <div class="card-header text-white theme_bg_color p-1">
            <div class="d-flex flex-row bd-highlight">
                <div class="flex-grow-1 bd-highlight mt-1"><span class="h5">{{ __('Purchase Items Reports')}}</span>
                </div>
        ...
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <table id="purchaseitemreportreport_id" class="table text-center table-hover m-0 p-0">
                    <thead>
                        <tr
                    ...
                    <tbody>
                        @foreach ($this->purchaseitemreport as $key => $item)
                            <tr>
