                ...
                <div class="modal-body bg-white">
                    <div class="row g-3">
                        @include('helper.formhelper.form', [
                            'type' => 'text',
                            'fieldname' => 'form.country_name',
                            'labelname' => 'COUNTRY NAME',
                            'labelidname' => 'country_nameid',
                            'required' => true,
                            'readonly' => false,
                            'col' => 'col-md-4',
                        ])
                        @include('helper.formhelper.form', [
                            'type' => 'text',
                            'fieldname' => 'form.currency_name',
                            'labelname' => 'CURRENCY NAME',
                            'labelidname' => 'currency_nameid',
                            'required' => true,
                            'readonly' => false,
                            'col' => 'col-md-4',
                        ])
                        @include('helper.formhelper.form', [
                            'type' => 'text',
                            'fieldname' => 'form.currency',
                            'labelname' => 'CURRENCY',
                            'labelidname' => 'currencyid',
                            'required' => true,
                            'readonly' => false,
                            'col' => 'col-md-4',
                        ])
