        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel"> {{ __('SHOW SUPPLIER') }} :
                        {{ $showdata->uniqid }}
                    </h5>
                ...
                <div class="modal-body bg-white">
                    <div class="row">
                        ...
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => $showdata->cpphone,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => __('CONTACT PERSON EMAIL'),
                            'value' => $showdata->cpmail,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
